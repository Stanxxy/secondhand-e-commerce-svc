...
├── secondhand_e_commerce_svc             # The main python package for the project
...
e.g: `cat secondhand_e_commerce_svc/VERSION` will get the project version without harming
