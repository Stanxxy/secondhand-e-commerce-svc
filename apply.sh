...
original_author="Stanxxy"
original_name="secondhand_e_commerce_svc"
original_urlname="secondhand-e-commerce-svc"
original_description="Awesome secondhand_e_commerce_svc created by Stanxxy" 
...
rm -rf "${name}"
rm -rf tests
cp -R ${TEMPLATE_DIR}/secondhand_e_commerce_svc "${name}"
...
then
    ...
    echo "then run 'secondhand_e_commerce_svc' or 'python -m secondhand_e_commerce_svc'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'secondhand_e_commerce_svc' or 'python -m secondhand_e_commerce_svc' or 'poetry run secondhand_e_commerce_svc'"
fi
