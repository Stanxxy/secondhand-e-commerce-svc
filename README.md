...
- 🎯 Entry points to execute your program using `python -m <secondhand_e_commerce_svc>` or `$ secondhand_e_commerce_svc` with basic CLI argument parsing.
...
---
# secondhand_e_commerce_svc Flask Application

Awesome secondhand_e_commerce_svc created by Stanxxy
...
```bash
git clone https://github.com/Stanxxy/secondhand-e-commerce-svc secondhand_e_commerce_svc
cd secondhand_e_commerce_svc
make install
```
...
```bash
pip install secondhand_e_commerce_svc
```
...
```bash
$ secondhand_e_commerce_svc
```

or

```bash
$ python -m secondhand_e_commerce_svc
```
...
```bash
secondhand_e_commerce_svc create-db   # run once
secondhand_e_commerce_svc populate-db  # run once (optional)
secondhand_e_commerce_svc add-user -u admin -p 1234  # ads a user
secondhand_e_commerce_svc run
```
